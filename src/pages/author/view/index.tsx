...
const aboutAuthorData = {
    ...
    skills: ['JavaScript', 'React', 'Node.js', 'Python', 'AI', 'Blockchain', 'Web Development']
}
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-11">
          <Tabs defaultValue="article" className="w-full">
            <TabsList>
              <TabsTrigger className="w-full" value="article">Aricles</TabsTrigger>
              <TabsTrigger className="w-full" value="about">About</TabsTrigger>
            </TabsList>
